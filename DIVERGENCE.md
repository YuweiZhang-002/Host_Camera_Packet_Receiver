...
| `scripts_ps/calibration/run_intrinsic_calibration.ps1` | Added a portable preflight/training/V1/V2 runner with dry-run behavior and a run manifest. | Replace Attempt-specific command fragments with one public entry point. |
